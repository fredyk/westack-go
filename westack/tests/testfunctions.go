...
func invokeApiM(t *testing.T, method string, url string, body wst.M, headers wst.M) (result wst.M, err error) {
	result, err = invokeApiTyped[wst.M](t, method, url, body, headers)
	return result, err
}

func invokeApiA(t *testing.T, method string, url string, body wst.M, headers wst.M) (result wst.A, err error) {
...
func invokeApiAsRandomUser(t *testing.T, method string, url string, body wst.M, headers wst.M) (result wst.M, err error) {
	...
	return invokeApiM(t, method, url, body, headers)
}
