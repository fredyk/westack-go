...
func (cursor *ErrorCursor) All() (result []Instance, err error) {
	return result, cursor.Error()
}
...
func (cursor *FixedLengthCursor) All() (result []Instance, err error) {
...
func newFixedLengthCursor(instances []Instance) Cursor {
